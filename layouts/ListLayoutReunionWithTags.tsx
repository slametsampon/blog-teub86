...
import type { Blog, Reunion } from 'contentlayer/generated'
...
interface ListLayoutProps {
  posts: CoreContent<Reunion>[]
  title: string
  initialDisplayPosts?: CoreContent<Reunion>[]
...
export default function ListLayoutReunionWithTags({
  posts,
  title,
  initialDisplayPosts = [],
  pagination,
